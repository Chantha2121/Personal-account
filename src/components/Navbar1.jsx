    ...
    <div className="z-20 fixed w-full top-0">
      ...
      <div className=' hidden lg:flex bg-[#2b1a5d] text-[#20FFD0] h-16 text-lg rounded-xl mt-3:'>
        <ul className=' hidden md:flex items-center'>
          <li className=' ml-12 mx-auto p-2 hover:text-blue-700'><a href="/">Home</a></li>
      ...
      <div onClick={handleNav} className="block lg:hidden text-red-600 w-10">
        {nav ? <AiOutlineClose size={20}/> : <AiOutlineMenu size={20}/>}
      </div>
      <ul className={nav ? ' bg-black text-gray-200 fixed h-full left-0 top-0 w-[70%] border-r border-r-gray-900 ease-in-out duration-200': 
                          ' fixed left-[100%]'}>
        <div className='flex'>
        ...
        <li className='mx-5 mt-5 p-2 text-xl hover:text-[#af38ff]'><a href="/">Home</a></li>
        <li className='mx-5 mt-2 p-2 text-xl hover:text-[#af38ff]'><a href="#about">About</a></li>
        <li className='mx-5 mt-2 p-2 text-xl hover:text-[#af38ff]'><a href="#work">Projects</a></li>
        <li className='mx-5 mt-2 p-2 text-xl hover:text-[#af38ff]'><a href="#contact">Contact</a></li>
      </ul>
    </div>
    </div>
